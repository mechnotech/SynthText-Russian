...
class RendererV3(object):
    ...
    def bb_filter(self, bb0, bb, text):
        ...
        is_good = (min_h > self.min_char_height
                   and self.min_asp_ratio < asp_ratio < 1.0 / self.min_asp_ratio) and not np.any(algebraic_hw < 0)
        # print('isgood')
        # print(is_good)
        return is_good
    ...
    def render_text(self, rgb, depth, seg, area, label, ninstance=1):
        ...
        for i in range(ninstance):
            ...
            # print(np.arange(NUM_REP * num_txt_regions))
            # print(reg_range)
